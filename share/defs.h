...
TFAlias client_aliases[] = {
    ...
    {"-quick4",                 0,  "-attack"},
    {"menu",                    0,  "tf_menu special", 0, "cmd menu"},
    {"changeteam",              0,  "tf_menu team", TF_CHANGETEAM},
    ...
    {"changeclass",             0,  "tf_menu class",      TF_CHANGECLASS},
    ...
    {"dropkey",                 TF_DROPKEY},
    {"dropammo",                0,  "tf_menu dropammo", TF_DROP_AMMO},
    ...
    {"disguise",                0,  "tf_menu disguise", TF_SPY_SPY},
    {"feign",                   TF_SPY_FEIGN},
    ...
    {"build",                   0,  "tf_menu build", TF_ENGINEER_BUILD},
